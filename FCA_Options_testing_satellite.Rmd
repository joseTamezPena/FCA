...
print(table(Satellite$classes))

soilnames <- names(table(Satellite$classes))
ncn <- c("RS","CC","GS","DGS","VS","VDGS")
names(ncn) <- soilnames
Satellite$classes <- as.factor(ncn[Satellite$classes])
print(table(Satellite$classes))
