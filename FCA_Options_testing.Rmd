...
# system.time(datasetframeDecor <- GDSTMDecorrelation(datasetframe_train,Outcome=Outcome))
# baseF <- attr(datasetframeDecor,"baseFeatures")
# pander::pander(baseF)
...
#system.time(datasetframeDecor <- GDSTMDecorrelation(datasetframe_train,type="RLM",method="pearson"))
#system.time(datasetframeDecor <- GDSTMDecorrelation(datasetframe_train,method="spearman"))
#system.time(datasetframeDecor <- GDSTMDecorrelation(datasetframe_train,type="RLM",method="spearman"))

#baseF <- attr(datasetframeDecor,"AbaseFeatures")
#pander::pander(baseF)


#system.time(datasetframeDecor <- GDSTMDecorrelation(datasetframe_train,Outcome=Outcome,type="RLM",method="pearson"))
#system.time(datasetframeDecor <- GDSTMDecorrelation(datasetframe_train,Outcome=Outcome,method="spearman"))
system.time(datasetframeDecor <- GDSTMDecorrelation(datasetframe_train,Outcome=Outcome,type="RLM",method="spearman"))
#baseF <- attr(datasetframeDecor,"baseFeatures")
#pander::pander(baseF)
