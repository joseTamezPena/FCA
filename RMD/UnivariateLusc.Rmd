...
#rluscdataset <- subset(luscdataset,surtime > 1.5 | status==1)
...
#DEdataframe <- GDSTMDecorrelation(dataframe,Outcome=outcome,method="spearman",type="LM",thr=0.40,verbose = TRUE)
#DEdataframe <- GDSTMDecorrelation(dataframe,method="spearman",type="LM",thr=0.40,verbose = TRUE)
#DEdataframe <- GDSTMDecorrelation(dataframe,Outcome=outcome,method="spearman",type="LM",thr=0.30,verbose = TRUE)
DEdataframe <- GDSTMDecorrelation(dataframe,thr=0.30,verbose = TRUE)
