...
#DEdataframe <- IDeA(dataframe,Outcome=outcome,method="spearman",type="LM",thr=0.40,verbose = TRUE)
#DEdataframe <- IDeA(dataframe,method="spearman",type="LM",thr=0.40,verbose = TRUE)
#DEdataframe <- IDeA(dataframe,Outcome=outcome,method="spearman",type="LM",thr=0.30,verbose = TRUE)
DEdataframe <- IDeA(dataframe,thr=0.30,verbose = TRUE)
