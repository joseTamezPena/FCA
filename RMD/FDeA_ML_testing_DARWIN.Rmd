...
```{r results = "asis", warning = FALSE, dpi=600, fig.height= 6.0, fig.width= 8.0}
nrow(bm$bagging$formulaNetwork)
csum <- apply(bm$bagging$formulaNetwork,2,sum)
cnames <- names(csum[csum>0.5])
gplots::heatmap.2(log10(100*bm$bagging$formulaNetwork[cnames,cnames]+1),
                  trace = "none",
                  scale = "none",
                  mar = c(10,10),
                  col=rev(heat.colors(5)),
...
```{r results = "asis", warning = FALSE, dpi=600, fig.height= 6.0, fig.width= 8.0}
nrow(bmd$bagging$formulaNetwork)
csum <- apply(bmd$bagging$formulaNetwork,2,sum)
cnames <- names(csum[csum>0.5])
gplots::heatmap.2(log10(100*bmd$bagging$formulaNetwork[cnames,cnames]+1),
                  trace = "none",
                  scale = "none",
                  mar = c(10,10),
                  col=rev(heat.colors(5)),
                  main = "BSWiMS Network: Outcome Driven",
                  cexRow = 0.45,
                  cexCol = 0.45,
                  key.title=NA,
                  key.xlab="log10(# of Connections)",
...
```{r results = "asis", warning = FALSE, dpi=600, fig.height= 6.0, fig.width= 8.0}
nrow(bmdU$bagging$formulaNetwork)
csum <- apply(bmdU$bagging$formulaNetwork,2,sum)
cnames <- names(csum[csum>0.5])
gplots::heatmap.2(log10(100*bmdU$bagging$formulaNetwork[cnames,cnames]+1),
                  trace = "none",
                  scale = "none",
                  mar = c(10,10),
                  col=rev(heat.colors(5)),
                  main = "BSWiMS Network: Unsupervised",
                  cexRow = 0.45,
                  cexCol = 0.45,
                  key.title=NA,
                  key.xlab="log10(# of Connections)",
