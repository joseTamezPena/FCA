...
DEdataframe <- list();
optionNames <- character(17);

DEdataframe<- append(DEdataframe,GDSTMDecorrelation(dataframe,Outcome=outcome,verbose = TRUE))
optionNames <- c(optionNames,"OD_LM_FAST_R")

DEdataframe <- append(DEdataframe,GDSTMDecorrelation(dataframe,Outcome=outcome,type="LM",method="pearson",verbose = TRUE))
optionNames <- c(optionNames,"OD_LM_Pearson_R")

DEdataframe <- append(DEdataframe,GDSTMDecorrelation(dataframe,Outcome=outcome,type="LM",method="spearman",verbose = TRUE))
optionNames <- c(optionNames,"OD_LM_Spearman_R")

DEdataframe <- append(DEdataframe,GDSTMDecorrelation(dataframe,Outcome=outcome,type="RLM",method="pearson",verbose = TRUE))
optionNames <- c(optionNames,"OD_RLM_Pearson_R")

DEdataframe <- append(DEdataframe,GDSTMDecorrelation(dataframe,Outcome=outcome,type="RLM",method="spearman",verbose = TRUE))
optionNames <- c(optionNames,"OD_RLM_Spearman_R")

DEdataframe <- append(DEdataframe,GDSTMDecorrelation(dataframe,verbose = TRUE))
optionNames <- c(optionNames,"B_LM_Pearson_R")

DEdataframe <- append(DEdataframe,GDSTMDecorrelation(dataframe,type="LM",method="spearman",verbose = TRUE))
optionNames <- c(optionNames,"B_LM_Spearman_R")

DEdataframe <- append(DEdataframe,GDSTMDecorrelation(dataframe,type="RLM",method="pearson",verbose = TRUE))
optionNames <- c(optionNames,"B_RLM_Pearson_R")

DEdataframe <- append(DEdataframe,GDSTMDecorrelation(dataframe,type="RLM",method="spearman",verbose = TRUE))
optionNames <- c(optionNames,"B_RLM_Spearman_R")

DEdataframe <- append(DEdataframe,GDSTMDecorrelation(dataframe,Outcome=outcome,skipRelaxed=TRUE,verbose = TRUE))
optionNames <- c(optionNames,"OD_LM_Pearson_NR")

DEdataframe <- append(DEdataframe,GDSTMDecorrelation(dataframe,Outcome=outcome,type="LM",method="spearman",skipRelaxed=TRUE,verbose = TRUE))
optionNames <- c(optionNames,"OD_LM_Spearman_NR")

DEdataframe <- append(DEdataframe,GDSTMDecorrelation(dataframe,Outcome=outcome,type="RLM",method="pearson",skipRelaxed=TRUE,verbose = TRUE))
optionNames <- c(optionNames,"OD_RLM_Pearson_NR")

DEdataframe <- append(DEdataframe,GDSTMDecorrelation(dataframe,Outcome=outcome,type="RLM",method="spearman",skipRelaxed=TRUE,verbose = TRUE))
optionNames <- c(optionNames,"OD_RLM_Spearman_NR")

DEdataframe <- append(DEdataframe,GDSTMDecorrelation(dataframe,skipRelaxed=TRUE,verbose = TRUE))
optionNames <- c(optionNames,"B_LM_Pearson_NR")

DEdataframe <- append(DEdataframe,GDSTMDecorrelation(dataframe,type="LM",method="spearman",skipRelaxed=TRUE,verbose = TRUE))
optionNames <- c(optionNames,"B_LM_Spearman_NR")

DEdataframe <- append(DEdataframe,GDSTMDecorrelation(dataframe,type="RLM",method="pearson",skipRelaxed=TRUE,verbose = TRUE))
optionNames <- c(optionNames,"B_RLM_Pearson_NR")

DEdataframe <- append(DEdataframe,GDSTMDecorrelation(dataframe,type="RLM",method="spearman",skipRelaxed=TRUE,verbose = TRUE))
