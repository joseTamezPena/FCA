...
cormat <- cor(dataframe[,varlist[1:1000,1]],method="spearman")
...
cormat <- cor(DEdataframe[,varlistDe[1:1000,1]],method="spearman")
cormat[is.na(cormat)] <- 0
gplots::heatmap.2(abs(cormat),
                  trace = "none",
#                  scale = "none",
...
```{r results = "asis"}
topDecorNames <- rownames(univarDe$orderframe[univarDe$orderframe$FRes.p<1.0e-7,])
