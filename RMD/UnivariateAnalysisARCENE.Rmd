...
```{r results = "asis"}
#DEdataframe <- GDSTMDecorrelation(dataframe,Outcome=outcome,thr=0.80,verbose = TRUE,corRank=FALSE)
DEdataframe <- GDSTMDecorrelation(dataframe,thr=0.80,verbose = TRUE,corRank=FALSE)
#DEdataframe <- GDSTMDecorrelation(dataframe,thr=0.80,verbose = TRUE,relaxed=FALSE)
...
#if (length(selectedlist)>10)
#{
#  selectedlist <- selectedlist[1:10]
#}
