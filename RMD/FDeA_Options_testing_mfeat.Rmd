...
This document describes the use of the **FRESA.CAD::IDeA()** function that runs the feature correlation analysis (**FDeA**) algorithm on the mfeat data set:
