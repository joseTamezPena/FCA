...
-   The name will have the "La\_" prefix is the feature was original correlated and its correlation to "Ba\_" features has been removed. Hence a latent variable.
...
$$
F_j=∑_{n}∑_{i∈B^{n}_{j}}(|ρ_{i,j}|>ρ_{th}),~ \forall j \in Ind
$$

$$
F_j=F_j-∑_{n}|ρ_{B^n_j,j}| > ρ_{th} ,~ \forall j \in Dep
$$
