---
title: "TADPOLE_Survival (Options)"
author: "Jose Tamez"
date: "`r Sys.Date()`"
output: 
  html_document: 
...
## Decorrelation Analysis @Fast_No Outcome

```{r results = "asis"}
thr <- 0.5
#DEdataframe <- GDSTMDecorrelation(dataframe,Outcome=outcome,thr=0.50,verbose = TRUE,skipRelaxed=FALSE)
DEdataframe <- GDSTMDecorrelation(dataframe,thr=thr,verbose = TRUE,skipRelaxed=FALSE)
...
## Univariate Decorrelated @Fast_No Outcome
...
### Survival plot of top feature @Fast_No Outcome
...
### The Top Significant Figures @Fast_No Outcome
...
## Decorrelation Analysis @FAST Outcome

```{r results = "asis"}
thr <- 0.5
#DEdataframe <- GDSTMDecorrelation(dataframe,Outcome=outcome,thr=0.50,verbose = TRUE,skipRelaxed=FALSE)
DEdataframe <- GDSTMDecorrelation(dataframe,Outcome=outcome,thr=thr,verbose = TRUE,skipRelaxed=FALSE)
demat <- attr(DEdataframe,"GDSTM")
...
## Univariate Decorrelated @FAST Outcome
...
### Survival plot of top feature @FAST Outcome
...
### The Top Significant Figures @FAST Outcome
...
## Decorrelation Analysis @spearman no Outcome
...
## Univariate Decorrelated @spearman no Outcome
...
### Survival plot of top feature @spearman no Outcome
...
### The Top Significant Figures @spearman no Outcome
...
### Final Table @spearman no Outcome
...
## Decorrelation Analysis @spearman Outcome

```{r results = "asis"}
thr <- 0.50
#DEdataframe <- GDSTMDecorrelation(dataframe,Outcome=outcome,thr=0.50,verbose = TRUE,skipRelaxed=FALSE)
DEdataframe <- GDSTMDecorrelation(dataframe,Outcome=outcome,thr=thr,method="spearman",verbose = TRUE,skipRelaxed=FALSE)
demat <- attr(DEdataframe,"GDSTM")
...
## Univariate Decorrelated @spearman Outcome
...
### Survival plot of top feature @spearman Outcome
...
### The Top Significant Figures @spearman Outcome
