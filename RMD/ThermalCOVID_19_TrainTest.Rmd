...
deTrain <- GDSTMDecorrelation(trainSet,Outcome="class",thr=0.8,verbose = TRUE,corRank=FALSE)
deTest <- predictDecorrelate(deTrain,testSet)

## The GDSTM transformation without outcome
deTrainU <- GDSTMDecorrelation(trainSet,thr=0.8,verbose = TRUE,corRank=FALSE)
